        ...
        <form action="process.php" method="POST" class="login__form login__form--white-smoke col-xl-4 col-lg-6 col-md-8 col-xs-10 p-3">
            ...
            <div class="form-group m-0">
                <div class="input-group mb-2">
                    ...
                    <input name="name" type="text" class="form-control" placeholder="Input your email">
                </div>
                <div class="input-group">
                    ...
                    <input name="project" type="text" class="form-control" placeholder="Input your Password" >
                </div>
